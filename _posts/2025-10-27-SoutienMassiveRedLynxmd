...
La section Solidaires Informatique d'Ubisoft Paris Studio apporte son total soutien aux collègues de Suède et Finlande qui subissent les conséquences d'une direction qui n'assume pas ses échecs et préfère les reporter sur les salarié-es en continuant de supprimer des postes partout, et qui s'en prend principalement aux personnes qui sont en intermission ; pour rappel, la loi française oblige 
l'entreprise à fournir un travail aux salariés. 
